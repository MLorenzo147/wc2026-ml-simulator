...
def build_dataset(
    international_results: Path,
    fifa_rankings: Path | None,
    squad_csv: Path | None,
    player_stats: Path | None,
    dataset_out: Path,
    team_features_out: Path | None,
    elo_out: Path | None,
    form_out: Path | None,
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--dataset-out",
        default="data/processed/match_dataset.csv",
        help="Output match dataset CSV",
    )
    parser.add_argument(
        "--team-features-out",
        default="data/processed/national_team_features.csv",
    ...
    parser.add_argument(
        "--form-out",
        default="data/processed/matches_with_form.csv",
