...
TEAM_MAPPING = {
    ...
    "Brésil": "Brazil",
    "Canada": "Canada",
    "Cap-Vert": "Cabo Verde",  # Souvent "Cape Verde" selon les datasets
    "Colombie": "Colombia",
    ...
    "Croatie": "Croatia",
    "Curaçao": "Curaçao",  # Parfois sans cédille : "Curacao"
    "Écosse": "Scotland",
    "Égypte": "Egypt",
    "Équateur": "Ecuador",
    "Espagne": "Spain",
    "Etats-Unis": "USA",  # Ou "United States" selon ton CSV
    "États-Unis": "USA",
    "France": "France",
    "Ghana": "Ghana",
    "Haïti": "Haiti",
    "Iran": "IR Iran",  # Ou "Iran" selon ton CSV
    "Japon": "Japan",
    "Jordanie": "Jordan",
    "Maroc": "Morocco",
    "Mexique": "Mexico",
