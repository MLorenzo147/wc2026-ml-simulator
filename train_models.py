...
def main() -> None:
    ...
    parser.add_argument(
        "--models-dir", default="data/processed/models", help="Output dir"
    )
    ...
    train_df, val_df, _ = split_by_date(df, args.train_end, args.val_end)
    fit_df = (
        pd.concat([train_df, val_df], ignore_index=True) if args.use_val else train_df
    )
